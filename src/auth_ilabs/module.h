...
#pragma once
#ifndef __ILABS_AUTH_MODULE_H__
#define __ILABS_AUTH_MODULE_H__

#include <measureserver/module.h>

namespace Auth_ILabs
{

class Callback;

class ILabsAuthModule : public Module
{
public:
	...
	ILabsAuthModule();
	virtual ~ILabsAuthModule();
private:
	ModuleServices*	mpServices;
	Callback*		mpCallback;
//	MysqlDatabase*	mpDatabase;
};
